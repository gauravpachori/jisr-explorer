export const FolderSvg = ({ fill = ["#FFC36E", "#FFD782"], ...rest }) => (
...
export const FileSvg = ({ fill = ["#FFC36E", "#FFD782"], ...rest }) => (
    <svg viewBox="0 0 512 512" {...rest}>
        <rect fill={fill[1]} width="512" height="512" />
        <rect x="256" fill={fill[0]} width="256" height="512" />
        <g>
            <rect
                x="109.714"
                y="131.657"
        ...
        <polygon
            fill={fill[1]}
            points="512,431.543 462.832,462.832 431.543,512 512,512 "
        />
        <path fill="#FFFFFF" d="M431.543,512v-80.457H512L431.543,512z" />
    </svg>
);
